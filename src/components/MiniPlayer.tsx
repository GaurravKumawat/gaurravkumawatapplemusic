...
export function MiniPlayer() {
  ...
  return (
    <motion.button
      ...
      className="fixed left-2 right-2 bottom-[calc(env(safe-area-inset-bottom)+82px)] z-40 glass-strong rounded-2xl shadow-2xl border border-border overflow-hidden text-left active:scale-[0.985] transition-transform"
    >
